...
| --------- | ------------------: | -------------: | --------: |
| Aggregate |             728,316 |        239,496 |     67.1% |
...
The v3.1.1 follow-up adds the same additive bounding-box metadata to the detailed
aggregate and updates its byte measurements. It changes no geometry coordinates.
